...
class TestLiftUnlift(TestCase):
    ...
    def test_lift_basic(self):
        ...
        self.assertIn("const_tensor", constants)
        self.assertEqual(constants["const_tensor"], const_tensor)
        self.assertIn("const_obj", constants)
        self.assertEqual(constants["const_obj"], const_obj)
        ...
        self.assertEqual(lifted_tensor_placeholder.target, "const_tensor")
        ...
        self.assertEqual(lifted_obj_placeholder.target, "const_obj")
        # It should have a val equivalent to the constant
        self.assertEqual(
    ...
    def test_lift_nested(self):
        ...
        # The key of the constants table should match the fqn of the constant.
        self.assertIn("foo.const_tensor", constants)
        self.assertEqual(constants["foo.const_tensor"], const_tensor)
        ...
        self.assertEqual(lifted_constant_placeholder.target, "const_tensor")
